...
import com.p1nesap.ezdungeon.levels.painters.*;
import com.p1nesap.utils.Bundle;
import com.p1nesap.utils.Graph;
import com.p1nesap.utils.Random;
import com.p1nesap.utils.Rect;
...
public abstract class RegularLevel extends Level {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		//rooms = new HashSet<Room>( (Collection<Bundlable>) bundle.getCollection( "rooms" ) );
		// was <? extends Room> now <Bundlable>
        for (Room r : rooms) {
			if (r.type == Type.WEAK_FLOOR) {
				weakFloorCreated = true;
				break;
