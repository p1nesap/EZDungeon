 ...
 */
package com.p1nesap.ezdungeon.scenes;

import java.io.IOException;

import com.p1nesap.ezdungeon.EZDungeon;
import com.p1nesap.noosa.Camera;
import com.p1nesap.noosa.Game;
import com.p1nesap.noosa.Group;
import com.p1nesap.noosa.SkinnedBlock;
import com.p1nesap.noosa.Visual;
import com.p1nesap.noosa.audio.Music;
import com.p1nesap.noosa.audio.Sample;
import com.p1nesap.noosa.particles.Emitter;
...
import com.p1nesap.ezdungeon.FogOfWar;
...
import com.p1nesap.ezdungeon.effects.BannerSprites;
import com.p1nesap.ezdungeon.effects.BlobEmitter;
import com.p1nesap.ezdungeon.effects.EmoIcon;
import com.p1nesap.ezdungeon.effects.Flare;
import com.p1nesap.ezdungeon.effects.FloatingText;
import com.p1nesap.ezdungeon.effects.Ripple;
import com.p1nesap.ezdungeon.effects.SpellSprite;
import com.p1nesap.ezdungeon.items.Heap;
import com.p1nesap.ezdungeon.items.Item;
import com.p1nesap.ezdungeon.items.wands.WandOfBlink;
...
import com.p1nesap.ezdungeon.plants.Plant;
import com.p1nesap.ezdungeon.sprites.CharSprite;
import com.p1nesap.ezdungeon.sprites.DiscardedItemSprite;
import com.p1nesap.ezdungeon.sprites.HeroSprite;
import com.p1nesap.ezdungeon.sprites.ItemSprite;
import com.p1nesap.ezdungeon.sprites.PlantSprite;
import com.p1nesap.ezdungeon.ui.AttackIndicator;
import com.p1nesap.ezdungeon.ui.Banner;
import com.p1nesap.ezdungeon.ui.BusyIndicator;
import com.p1nesap.ezdungeon.ui.GameLog;
import com.p1nesap.ezdungeon.ui.HealthIndicator;
import com.p1nesap.ezdungeon.ui.QuickSlot;
import com.p1nesap.ezdungeon.ui.StatusPane;
import com.p1nesap.ezdungeon.ui.Toast;
import com.p1nesap.ezdungeon.ui.Toolbar;
import com.p1nesap.ezdungeon.ui.Window;
import com.p1nesap.ezdungeon.utils.GLog;
import com.p1nesap.ezdungeon.windows.WndBag.Mode;
import com.p1nesap.ezdungeon.windows.WndGame;
import com.p1nesap.ezdungeon.windows.WndBag;
import com.p1nesap.ezdungeon.windows.WndStory;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		EZDungeon.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( defaultZoom + EZDungeon.zoom() );
		...
		brightness( EZDungeon.brightness() );
