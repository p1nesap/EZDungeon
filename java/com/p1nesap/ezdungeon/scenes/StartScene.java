...
import com.p1nesap.noosa.ui.Button;
...
import com.p1nesap.ezdungeon.effects.BannerSprites.Type;
import com.p1nesap.ezdungeon.ui.Archs;
import com.p1nesap.ezdungeon.ui.ExitButton;
import com.p1nesap.ezdungeon.ui.Icons;
import com.p1nesap.ezdungeon.ui.RedButton;
import com.p1nesap.ezdungeon.utils.Utils;
import com.p1nesap.ezdungeon.windows.WndChallenges;
import com.p1nesap.ezdungeon.windows.WndClass;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		curClass = null;
		updateClass( HeroClass.values()[EZDungeon.lastClass()] );
	...
	protected void onBackPressed() {
		EZDungeon.switchNoFade(TitleScene.class);
	}
	...
	private class ChallengeButton extends Button {
		...
		protected void createChildren() {
			...
			image = Icons.get( EZDungeon.challenges() > 0 ? Icons.CHALLENGE_ON :Icons.CHALLENGE_OFF );
			add( image );
		}
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				add( new WndChallenges( EZDungeon.challenges(), true ) {
					public void onBackPressed() {
						super.onBackPressed();
						image.copy( Icons.get( EZDungeon.challenges() > 0 ?
