 ...
 */
package com.p1nesap.ezdungeon.actors.hero;
...
import com.p1nesap.ezdungeon.Bones;
import com.p1nesap.ezdungeon.Dungeon;
import com.p1nesap.ezdungeon.GamesInProgress;
...
import com.p1nesap.ezdungeon.actors.buffs.Bleeding;
...
import com.p1nesap.ezdungeon.actors.buffs.Combo;
import com.p1nesap.ezdungeon.actors.buffs.Cripple;
import com.p1nesap.ezdungeon.actors.buffs.Fury;
import com.p1nesap.ezdungeon.actors.buffs.GasesImmunity;
import com.p1nesap.ezdungeon.actors.buffs.Hunger;
import com.p1nesap.ezdungeon.actors.buffs.Invisibility;
import com.p1nesap.ezdungeon.actors.buffs.Light;
...
import com.p1nesap.ezdungeon.actors.buffs.Regeneration;
import com.p1nesap.ezdungeon.actors.buffs.Roots;
import com.p1nesap.ezdungeon.actors.buffs.Charm;
import com.p1nesap.ezdungeon.actors.buffs.SnipersMark;
import com.p1nesap.ezdungeon.actors.buffs.Vertigo;
import com.p1nesap.ezdungeon.actors.buffs.Weakness;
import com.p1nesap.ezdungeon.actors.mobs.Mob;
import com.p1nesap.ezdungeon.actors.mobs.npcs.NPC;
import com.p1nesap.ezdungeon.effects.CheckedCell;
import com.p1nesap.ezdungeon.effects.Flare;
import com.p1nesap.ezdungeon.effects.Speck;
import com.p1nesap.ezdungeon.items.Amulet;
import com.p1nesap.ezdungeon.items.Ankh;
import com.p1nesap.ezdungeon.items.DewVial;
...
import com.p1nesap.ezdungeon.items.KindOfWeapon;
import com.p1nesap.ezdungeon.items.armor.Armor;
import com.p1nesap.ezdungeon.items.keys.GoldenKey;
import com.p1nesap.ezdungeon.items.keys.Key;
import com.p1nesap.ezdungeon.items.keys.SkeletonKey;
import com.p1nesap.ezdungeon.items.keys.IronKey;
import com.p1nesap.ezdungeon.items.potions.PotionOfStrength;
import com.p1nesap.ezdungeon.items.rings.RingOfAccuracy;
import com.p1nesap.ezdungeon.items.rings.RingOfDetection;
import com.p1nesap.ezdungeon.items.rings.RingOfElements;
import com.p1nesap.ezdungeon.items.rings.RingOfEvasion;
import com.p1nesap.ezdungeon.items.rings.RingOfHaste;
import com.p1nesap.ezdungeon.items.rings.RingOfShadows;
import com.p1nesap.ezdungeon.items.rings.RingOfThorns;
import com.p1nesap.ezdungeon.items.scrolls.ScrollOfMagicMapping;
import com.p1nesap.ezdungeon.items.scrolls.ScrollOfRecharging;
import com.p1nesap.ezdungeon.items.scrolls.ScrollOfUpgrade;
import com.p1nesap.ezdungeon.items.wands.Wand;
import com.p1nesap.ezdungeon.items.weapon.melee.MeleeWeapon;
import com.p1nesap.ezdungeon.items.weapon.missiles.MissileWeapon;
import com.p1nesap.ezdungeon.levels.Level;
import com.p1nesap.ezdungeon.levels.Terrain;
import com.p1nesap.ezdungeon.levels.features.AlchemyPot;
import com.p1nesap.ezdungeon.levels.features.Chasm;
import com.p1nesap.ezdungeon.plants.Earthroot;
import com.p1nesap.ezdungeon.scenes.GameScene;
import com.p1nesap.ezdungeon.scenes.InterlevelScene;
import com.p1nesap.ezdungeon.scenes.SurfaceScene;
import com.p1nesap.ezdungeon.sprites.CharSprite;
import com.p1nesap.ezdungeon.sprites.HeroSprite;
import com.p1nesap.ezdungeon.ui.AttackIndicator;
import com.p1nesap.ezdungeon.ui.BuffIndicator;
import com.p1nesap.ezdungeon.ui.QuickSlot;
import com.p1nesap.ezdungeon.utils.GLog;
import com.p1nesap.ezdungeon.windows.WndMessage;
import com.p1nesap.ezdungeon.windows.WndResurrect;
import com.p1nesap.ezdungeon.windows.WndTradeItem;
import com.p1nesap.utils.Bundle;
import com.p1nesap.utils.Random;

public class Hero extends Char {
	
	private static final String TXT_LEAVE = "You must move forward!";
	...
	public float speed() {
		...
		if (aEnc > 0) {
			...
			return (float)(super.speed() * Math.pow( 1.7, -aEnc ));
			
		} else {
			
			float speed = super.speed();
			return ((HeroSprite)sprite).sprint( subClass == HeroSubClass.FREERUNNER && !isStarving() ) ? 2f * speed : speed;
			//was 1f ^^
		}
	}
