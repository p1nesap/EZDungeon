 ...
 */
package com.p1nesap.ezdungeon.actors;
...
import com.p1nesap.ezdungeon.actors.buffs.Sleep;
import com.p1nesap.ezdungeon.actors.buffs.Speed;
import com.p1nesap.ezdungeon.actors.buffs.Levitation;
...
import com.p1nesap.ezdungeon.actors.buffs.Slow;
...
public abstract class Char extends Actor {
	...
	protected static final String TXT_KILL		= "%s got you...";
	...
	public void damage( int dmg, Object src ) {
		...
		if (buff( Paralysis.class ) != null) {
			if (Random.Int( dmg ) >= Random.Int( HP )) {
				...
				/*if (Dungeon.visible[pos]) { COMMENTING OUT TEXT
