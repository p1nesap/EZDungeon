...
import com.p1nesap.ezdungeon.scenes.TitleScene;

public class EZDungeon extends Game {
	
	public EZDungeon() {
		super( TitleScene.class );
		
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.scrolls.ScrollOfUpgrade.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfEnhancement" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.actors.blobs.WaterOfHealth.class,
			"com.watabou.pixeldungeon.actors.blobs.Light" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.rings.RingOfMending.class,
			"com.watabou.pixeldungeon.items.rings.RingOfRejuvenation" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.wands.WandOfTelekinesis.class,
			"com.watabou.pixeldungeon.items.wands.WandOfTelekenesis" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.actors.blobs.Foliage.class,
			"com.watabou.pixeldungeon.actors.blobs.Blooming" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.actors.buffs.Shadows.class,
			"com.watabou.pixeldungeon.actors.buffs.Rejuvenation" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.scrolls.ScrollOfPsionicBlast.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfNuclearBlast" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.actors.hero.Hero.class,
			"com.watabou.pixeldungeon.actors.Hero" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.actors.mobs.npcs.Shopkeeper.class,
			"com.watabou.pixeldungeon.actors.mobs.Shopkeeper" );
		// 1.6.1
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.quest.DriedRose.class,
			"com.watabou.pixeldungeon.items.DriedRose" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.actors.mobs.npcs.MirrorImage.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfMirrorImage.MirrorImage" );
		// 1.6.4
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfCleansing" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfResistance" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.weapon.missiles.Boomerang.class,
			"com.watabou.pixeldungeon.items.weapon.missiles.RangersBoomerang" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.items.rings.RingOfPower.class,
			"com.watabou.pixeldungeon.items.rings.RingOfEnergy" );
		// 1.7.2
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.plants.Dreamweed.class,
			"com.watabou.pixeldungeon.plants.Blindweed" );
		com.p1nesap.utils.Bundle.addAlias(
			com.p1nesap.ezdungeon.plants.Dreamweed.Seed.class,
